...
from core_utils import multi_apply
from core_utils import force_fp32
from core_utils import reduce_mean
from core_utils import inverse_sigmoid
...
from bbox_util import normalize_bbox
...
class CmtHead(nn.Module):
    ...
    def __init__(self,
        ...
        self.bbox_coder = MultiTaskBBoxCoder(**args['bbox_coder'])
        ...
        for num_cls in self.num_classes:
            ...
            self.task_heads.append(SeparateTaskHead(**separate_head))
